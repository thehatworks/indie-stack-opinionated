...
async function main({ rootDirectory }) {
  ...
  const REPLACER = "indie-stack-opinionated-template";
  ...
  await Promise.all([
    ...
    fs.rm(path.join(rootDirectory, ".github/workflows/test-stack-deploy.yml")),
    fs.rm(path.join(rootDirectory, ".eslintignore")),
  ]);
