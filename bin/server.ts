...
// Lifted this line from official express adapter, still not sure precisely
// if it is necessary for some point in the future, but it is not causing
// issues and this entire file is unlikely to need major editing. It might even
// eventually go away if I decide express is fully pointless.
installGlobals();
